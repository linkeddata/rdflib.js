...
- N-Triples, N-Quads and TriG (`application/trig`) are serialized by the [N3.js](https://github.com/rdfjs/N3.js) writer and always produce spec-valid output; flags do not affect them.
