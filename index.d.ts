import { XMLHandler } from './ts-src/handlers/XMLHandler';
...
declare namespace rdflib {
  ...
  export class Fetcher {
    ...
    public lookUpThing(term: any, rterm: any, options?: any, oneDone?: any, allDone?: any): number;
     ...
     */
    public nowOrWhenFetched(uri: string, p2: any, userCallback: any, options?: any): void;
    public getHeader(doc: any, header: any): any[];
  ...
  export class IndexedFormula extends Formula {
    ...
    static XMLHandler: any;
    static HTMLHandler: any;
    static TextHandler: any;
    static N3Handler: any;
    propertyActions: any;
    classActions: any;
    redirections: any;
    aliases: any;
     ...
     */
    add(subj: Nodeable, pred?: Nodeable, obj?: Nodeable, why?: any): Statement;
    addAll(statements: Statement[]): void;
    any(s?: Nodeable, p?: Nodeable, o?: Nodeable, g?: Nodeable): any;
    anyValue(s: Nodeable, p: Nodeable, o: Nodeable, g: NamedNode | string): any;
    anyStatementMatching(subj?: Nodeable, pred?: Nodeable, obj?: Nodeable, why?: any): any;
     ...
     */
    match(subject?: Nodeable, predicate?: Nodeable, object?: Nodeable, graph?: NamedNode | string): any;
    /**
    ...
    /**
      ...
      */
    statementsMatching(subject?: Nodeable, predicate?: Nodeable, object?: Nodeable, why?: any, justOne?: any): any;
    /**
  ...
  export class Literal extends Node {
    ...
    lang: string;
    isVar: number;
    constructor(value: LiteralTypes, language?: any, datatype?: any);
    copy(): Literal;
    equals(other: any): boolean;
    language: string;
    toNT(): string;
