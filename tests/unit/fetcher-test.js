...
describe('Fetcher', () => {
  ...
  describe('initFetchOptions', () => {
    ...
    it('should set the Accept header', () => {
      ...
      let expectedHeader = 'image/*;q=0.9, */*;q=0.1, application/rdf+xml;q=0.9, application/xhtml+xml;q=0.8, text/xml;q=0.5, application/xml;q=0.5, text/html;q=0.8, text/plain;q=0.5, text/n3, text/turtle, application/ld+json;q=0.9'
