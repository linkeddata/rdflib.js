  ...
  describe('a JSON-LD document', () => {
    describe('with a base IRI', () => {
      ...
      it('uses the specified base IRI', () => {
        ...
        expect(list0First.subject.value).to.equal('n4')
        ...
        expect(list0Rest.subject.value).to.equal('n4')
        ...
        expect(list1First.subject.value).to.equal('n5')
        ...
        expect(list1Rest.subject.value).to.equal('n5')
        ...
        expect(list2First.subject.value).to.equal('n6')
        ...
        expect(list2Rest.subject.value).to.equal('n6')
        ...
        expect(listProp.object.value).to.equal('n4')
      })
    })
