...
tests = {
  statement: [
    {
      s: new $rdf.RDFSymbol("http://example.com/btb"),
      p: new $rdf.RDFSymbol("http://xmlns.com/foaf/0.1/name"),
      o: "Bob Builder",
  ...
  formula: [
    {
      ...
      s: new $rdf.BlankNode(),
      p: new $rdf.RDFSymbol("http://xmlns.com/foaf/0.1/firstname"),
      o: "Bob",
      expect: '{_:n0 <http://xmlns.com/foaf/0.1/firstname> "Bob" .}'
    }, {
      s: new $rdf.RDFSymbol("http://example.com/btb"),
      p: new $rdf.RDFSymbol("http://xmlns.com/foaf/0.1/lastname"),
      o: new $rdf.Literal("Builder", "en"),
      expect: '{<http://example.com/btb> <http://xmlns.com/foaf/0.1/lastname> "Builder"@en .}'
    }, {
      s: new $rdf.RDFSymbol("http://example.com/btb"),
      p: new $rdf.RDFSymbol("http://example.org/vocab#shoeSize"),
